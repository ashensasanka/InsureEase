...
class UserRegiterPage extends StatefulWidget {
  final Function()? onTap;
  final String userType;
  const UserRegiterPage({super.key, this.onTap, required this.userType});

  @override
  State<UserRegiterPage> createState() => _UserRegiterPageState();
}

class _UserRegiterPageState extends State<UserRegiterPage> {
