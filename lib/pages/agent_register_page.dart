...
class AgentRegiterPage extends StatefulWidget {
  final Function()? onTap;
  final String userType;
  const AgentRegiterPage({super.key, this.onTap, required this.userType});

  @override
  State<AgentRegiterPage> createState() => _AgentRegiterPageState();
}

class _AgentRegiterPageState extends State<AgentRegiterPage> {
                      ...
                      TextButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => AgentLoginPage(
