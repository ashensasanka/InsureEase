...
class ClaimAppPage extends StatefulWidget {
  const ClaimAppPage({super.key});

  @override
  State<ClaimAppPage> createState() => _CustomerAppPageState();
}

class _CustomerAppPageState extends State<ClaimAppPage> {
